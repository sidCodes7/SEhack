...
export default function ReportIssueScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await issuesService.reportIssue(formData);
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
        <Card style={styles.formCard}>
          ...
          <View style={styles.field}>
            ...
            <TextInput style={styles.textArea} placeholder="Provide more details…" placeholderTextColor="#A7A9BE" multiline numberOfLines={4} value={description} onChangeText={setDescription} textAlignVertical="top" />
          </View>
...
const styles = StyleSheet.create({
  ...
  textArea: { backgroundColor: '#F4F4EF', borderRadius: 12, padding: 16, fontFamily: FONTS.regular, fontSize: 14, color: '#1A1A1A', minHeight: 100 },
  ...
  chipText: { fontFamily: FONTS.medium, fontSize: 13, color: '#6B6B6B' },
  ...
  photoBtnText: { fontFamily: FONTS.medium, fontSize: 13, color: '#1A1A1A' },
  imageAttached: { fontFamily: FONTS.medium, fontSize: 13, color: '#45554F', marginTop: 4 },
  submitFab: { position: 'absolute', bottom: 40, right: SPACING.lg, width: 64, height: 64, borderRadius: 32, backgroundColor: '#1A1A1A', justifyContent: 'center', alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.2, shadowRadius: 20, elevation: 8 },
